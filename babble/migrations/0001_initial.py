# Generated by Django 4.1.5 on 2023-02-09 02:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to=babble.utils.image_file_path
                    ),
                ),
                (
                    "background",
            ...
            managers=[
                ("objects", babble.managers.PrivateUserManager()),
            ],
        ),
        migrations.CreateModel(
            name="Babble",
            fields=[
                ...
                (
                    "audio",
                    models.FileField(
                        blank=True, null=True, upload_to=babble.utils.audio_file_path
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("audio", models.FileField(upload_to=babble.utils.audio_file_path)),
                ("created", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            model_name="babble",
            name="tags",
            field=models.ManyToManyField(blank=True, null=True, to="babble.tag"),
        ),
        migrations.AddField(
            model_name="babble",
            name="user",
