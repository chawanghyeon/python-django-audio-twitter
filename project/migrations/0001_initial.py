    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to=project.utils.image_file_path
                    ),
                ),
                (
                    "background",
            ...
            managers=[
                ("objects", project.managers.PrivateUserManager()),
            ],
        ),
        migrations.CreateModel(
            name="Babble",
            fields=[
                ...
                (
                    "audio",
                    models.FileField(
                        blank=True, null=True, upload_to=project.utils.audio_file_path
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "babble",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="project.babble"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("audio", models.FileField(upload_to=project.utils.audio_file_path)),
                ("created", models.DateTimeField(auto_now_add=True)),
